...
class VideoCutter:
    ...
    def cut_scenes(self, scenes_dict, fps_original, bitrate="5000k", mode="Ambos", max_duration=50.0, min_duration=8.0, num_photos=5, hw_accel="CPU", preview_mode="Total", progress_callback=None, frame_callback=None, cancel_event=None, log_callback=None, global_person_counter=None, counter_lock=None):
        def _log(msg):
            if log_callback:
                log_callback(msg)
